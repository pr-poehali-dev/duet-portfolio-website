        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              Веб-дизайн, граф-дизайн, исследования, маркетинг, аналитика.
              <br />
              Инструменты: Figma, Метрики, Tilda, Illustrator, Photoshop.
              <br />
              Люблю креатив и исследования UX.
              <br />
              Опыт: 4 года.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              Граф-дизайн, брендинг, предпечатная подготовка, лендинги.
              <br />
              Инструменты: Illustrator, Photoshop, Figma.
              <br />
              Люблю рисовать и смелые решения.
              <br />
              Опыт: 4 года.
            </p>
          </div>
